...
\newcommand{\Authors}{Alexandre Bergel, Marco Orellana, David R\"othlisberger, Vanessa Pe\~na, Romain Charnay}
...
% tailoring the plan
\newboolean{talkAboutCapitalSemilla}
\setboolean{talkAboutCapitalSemilla}{true}
\ifthenelse{\boolean{talkAboutCapitalSemilla}}
	{\newcommand{\capitalSemilla}[1]{#1}}
	{\newcommand{\capitalSemilla}[1]{}}
...
%250 words
\begin{abstract}
Companies that produce software spend between 50\% and 75\% of their resources in maintaining their software, an activity that includes fixing bugs, adding missing features and re-implementing broken software. This incurs a billion dollars cost to the global software industry.
...
The product and services of QualityMonitor will be operated by Object Guidance, a recently created company. The international team behind Object Guidance is composed of 5 people. \capitalSemilla{We are currently applying for a 90,000 USD grant, resources that will be used to shape the solutions of client requirements.}
\end{abstract}
...
\paragraph{Vision of the company.} Become a global player in software quality. Offering a globally accessible solution, both in terms of cost and easiness to use, to measure and control the quality of a software product.

\paragraph{Vision of the product.} QualityMonitor will assist companies to produce better software and ease the software maintenance activities. By increasing the quality of software development, the total cost of a software development is reduced by 20\%-50\%.
...
QualityMonitor is the product and services we envision to answer the following questions: \emph{How to help development teams to easily maintain and continuously monitor the quality of their software programs?} and \emph{What are the actions to be taken to improve the quality of software development?}. We address these questions using expressive visualization mechanisms and automatic report generation. QualityMonitor automatically sends code quality reports based on the produced visualizations.
...
\item International composition of the Object Guidance team. An important socio-cultural factor in Chile is to positively perceive the interaction with Europeans and North-Americans.
...
Worldwide, the global software industry is evaluated at US\$ 457 billions. it is estimated that US\$ 228 billions is spent worldwide in maintenance activities. 


Symptoms of software quality problems are:
...
\paragraph{Customer profile.} 
Companies that are expressing their interest in QualityMonitor have very similar problems to solve, involving a critical legacy application that has to be maintained and possibly enhanced. Developers that produced the original versions moved into different projects or companies, leaving the software maintainers without an adequate knowledge base.

Our ideal customer profile includes producers of software that either develop locally or externalize the development. This profile includes large public administrations, banks, telecom companies and heavy industry (automobile, air carrier companies).
...
Once QualityMonitor is recognized by our Chilean customers, QualityMonitor will be ready to be publicly open, worldwide. 3 services will be offered around the QualityMonitor product:
...
\item \emph{Gold}: In addition to the silver service, clients will receive a monitoring by the QualityMonitor team. In addition to the report, the QualityMonitor team will coach clients in their effort to address identified quality problems. Clients will also be able to install a local version of QualityMonitor. This is particularly adequate in case of clients are unwilling from sending their source code via the Web.  
\end{itemize}
...
The overall objective of our enterprising effort is to reduce our personal involvement with QualityMonitor to analyze software, meaning that no time has to be allocated by the QualityMonitor team to realize a software analysis. Once we reach the stage that the cost of realizing an analyze is expressed in terms of server power instead of man power, services offered around QualityMonitor will be scalable. 
...
The Gold service for QualityMonitor involves human activities to follow a client's progress by suggesting recommendations for improvement. Clearly, this service may be a bottleneck against the scalability we are seeking. Possible solutions comprise (i) online lectures to cover general problems and (ii) automatized recommendation systems.

\paragraph{Price-to-earnings.}
Object Guidance is a \emph{sociedad por actions} \dr{not sociedad por acciones? maybe also put an English translation}under the Chilean chamber of commerce. Its capital is therefore evaluated in terms of stocks. 

The \emph{price-to-earnings ratio} (P/E) is a financial tool\footnote{\url{http://en.wikipedia.org/wiki/P/E_ratio}} applied to evaluate stock value. A high P/E ratio means that paying more for each unit of net income. The P/E ratio is often expressed in terms of years: it shows the number of years of earnings which are required to pay back purchase, ignoring inflation. 

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
\section{Timeline and budget for the first year} \seclabel{currentResources}
...
\capitalSemilla{\item October 2011 - Government sponsored 90,000 USD grant, \emph{Capital Semilla}. Two full time engineers will then be enrolled. }
...
\capitalSemilla{The 90,000 USD grant will therefore cover the initial 6,000 USD, leaving 42 man month, which will be used to develop QualityMonitor. }
...
\paragraph{Projection for the next 5 years.} We project our sells and the amount of users for the 3 services:

\begin{center}
\begin{tabular}{|c|c|c|c|c|c|}
\hline
Service & Year 1 & Year 2 & Year 3 & Year 4 & Year 5\\\hline
Free & 84 & 210 & 630 & 3,150 & 22,050 \\
Silver & 49 & 122 & 367 & 1837 & 12,862\\
Gold & 7 & 17 & 52 & 262 & 1,837\\\hline\hline

Total users & 100 & 250 & 750 & 3,750 & 26,250\\\hline
\end{tabular}
\end{center}

This projection has been established based on figures obtained from successful startups with a similar cost per product and similar market size. The cost per clients per silver users is US\$ 200 per month. The gold service will cost in the average US\$ 30,000 per year. The benefice of this service is 1 month of close coaching by the QualityMonitor team. 

\fig{}{0.75}{OptimisticIncome}{Income projection for the next 5 years}

\fig{}{0.75}{OptimisticUsers}{Amount of users projection for the next 5 years }

Our projection for the income is given in \figref{OptimisticIncome} and the total amount of clients in \figref{OptimisticUsers}.

\paragraph{Software industry. } Globally, the software industry is large. According to the DataMonitor market monitor\footnote{\url{http://www.datamonitor.com}}, the size of the worldwide software industry in 2013 will be US\$ 457 billion\footnote{\url{http://www.bsa.org/country/Public\%20Policy/~/media/Files/Policy/Security/General/sw_factsfigures.ashx}}. This represents an increase of 50.5\% since 2008. At least US\$ 228 billion is spent to software maintenance. Although this share is likely to decrease with the emergence of new market, which includes mobiles, this proportion remains significative. According to the nature of ObjectGuidance, 1\% is a reasonable fraction that QualityMonitor can tap into in the long run.
...
\item Vanessa Pe\~na -- Engineer in Computer Science, University of Chile. V. Pe\~na is an experimented programmer and was a student of A. Bergel. They know each other for more than 1.5 years. Christian is currently part time employee at Object Guidance.\\
...
Object Guidance is advised by Novos, the incubator associated to the University of Chile. Novos is helping the creation of Object Guidance by establishing the contact with designer, lawyer and CORFO, the Chilean public funding agency.
